...
STYLE_PRESETS = {
    ...
    "sports_fan": {
        ...
        "description": "Gestante usando camisa da Copa do Mundo de 2026 do Brasil (cropped), calça jeans, segurando miniatura da mesma camisa. Patriótico e divertido.",
        ...
        "outfit": "Cropped Brazil 2026 World Cup home jersey: bright canary yellow with green trim on collar and sleeve cuffs, blue and white accent stripes, CBF badge on chest with five stars above, number 10 (or blank) on front. Low-rise light wash denim jeans unbuttoned below belly. Bump fully exposed.",
        "pose": "Pure side profile, standing naturally, head turned slightly to look at a tiny replica of the same Brazil jersey held up with both hands raised in front, gaze focused on the small jersey, casual and playful mood.",
