...
| SendGrid        | `SENDGRID_API_KEY`          | `services/email_service.py`           | https://app.sendgrid.com/settings/api_keys                     |
...
4. **SendGrid**: Acesse Settings → API Keys → Create Key → atualize no Render.
